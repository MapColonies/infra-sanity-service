...
export interface components {
  schemas: {
    ...
    'com.github.openshift.api.route.v1.Route': {
      ...
      spec: components['schemas']['com.github.openshift.api.route.v1.RouteSpec'];
      /** @description status is the current state of the route */
      status?: components['schemas']['com.github.openshift.api.route.v1.RouteStatus'];
    };
    ...
    'com.github.openshift.api.route.v1.RouteIngress': {
      ...
      conditions?: components['schemas']['com.github.openshift.api.route.v1.RouteIngressCondition'][];
    ...
    'com.github.openshift.api.route.v1.RouteList': {
      ...
      items: components['schemas']['com.github.openshift.api.route.v1.Route'][];
      /** @description Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
      kind?: string;
    ...
    'com.github.openshift.api.route.v1.RouteSpec': {
      ...
      alternateBackends?: components['schemas']['com.github.openshift.api.route.v1.RouteTargetReference'][];
      ...
      port?: components['schemas']['com.github.openshift.api.route.v1.RoutePort'];
      ...
      tls?: components['schemas']['com.github.openshift.api.route.v1.TLSConfig'];
      ...
      to: components['schemas']['com.github.openshift.api.route.v1.RouteTargetReference'];
    ...
    'com.github.openshift.api.route.v1.RouteStatus': {
      ...
      ingress?: components['schemas']['com.github.openshift.api.route.v1.RouteIngress'][];
    };
